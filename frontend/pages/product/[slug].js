              ...
              <div className='flex'>
                ...
                <div className='flex items-center ml-auto '>
                  <button
                    ...
                    className='sm:ml-2 ml-1 text-white bg-indigo-500 border-0 py-1.5 px-1 md:py-2.5 md:px-4 sm:px-2 focus:outline-none hover:bg-indigo-600 rounded'>
                    <BiCart />
                  </button>
                  <button
                    onClick={() => router.push("/checkout")}
                    className='sm:ml-2 ml-1 text-white bg-indigo-500 border-0 py-1 px-1 md:py-2 md:px-4 sm:px-2 focus:outline-none hover:bg-indigo-600 rounded text-sm'>
                    Checkout
                  </button>
                  <button className='rounded-full w-10 h-10 bg-gray-200 p-0 ml-2 border-0 inline-flex items-center justify-center text-gray-500 sm:ml-4'>
                    <svg
                      fill='currentColor'
                      strokeLinecap='round'
                      strokeLinejoin='round'
